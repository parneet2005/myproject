function [trainedModel, validationRMSE] = t31baggedtreesmodel50(trainingData, responseData)
...
% Auto-generated by MATLAB on 24-Aug-2021 15:07:14
...
inputTable = array2table(trainingData, 'VariableNames', {'t31_dif'});

predictorNames = {'t31_dif'};
...
cvp = cvpartition(size(response, 1), 'Holdout', 0.5);
